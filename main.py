...
with open("data/lookup.txt", mode='r') as lookupData:
    ...
    # create hashmap with key : (dstport, protocol) , value : tag
...
# key : protocol decimal (i.e. 6) , value : protocol keyword (i.e. tcp)
...
with open("data/logs.txt", mode='r') as logs:
    ...
    while row:
        ...
        # check for missing or skipped data by checking row[13] (log-status) - > IGNORE LINE
        ...
        try:
            # case 1 : (port, protocol) pair is present in tagMap
            ...
            # case 2 : (port, protocol) pair is NOT present in tagMap
